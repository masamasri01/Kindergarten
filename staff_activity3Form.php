    ...
    <div class="content-wrapper bg-white">
        ...
        <section class="content">
            ...
            <div class="container mb-3">
                <form action="nap.php" class="row" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="" class="form-label">Nap Start Time</label>
                                <input name="start" type="time" class="form-control" >
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="" class="form-label">Nap End Time</label>
                    ...
                    <label for="" class="form-label">Insert image of the activity! </label>
