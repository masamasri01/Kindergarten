                    ...
                    <div class="tab-content col-md-9 col-sm-8" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-room1" role="tabpanel"
                            ...
                            <div class="d-flex justify-content-between align-items-center py-2  border-bottom">
                                <h2 class="fs-4">child name</h2>
                            </div>

                         <form method="post" action="rooms.php">
                             <input type="text" value="1" name="theId" id="theId">
                            <ul class="nav nav-pills roomContent mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button name="submit1" type="submit" class="nav-link fw-bold" id="pills-profile-tab" data-bs-toggle="pill"
                                                      data-bs-target="#pills-profile"  role="tab"
                                                      aria-controls="pills-profile" aria-selected="true">staff
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button name="submit1" type="submit" class="nav-link fw-bold active" id="pills-home-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-home"  role="tab"
                                            aria-controls="pills-home" aria-selected="true">kids
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button name="submit" type="submit" class="nav-link fw-bold active" id="pills-home-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-profile"  role="tab"
                                            aria-controls="pills-home" aria-selected="true">staff
                                    </button>
                                </li>
                            </ul>
                         </form>
