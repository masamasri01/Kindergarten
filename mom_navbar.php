        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    <a href="mom_index.php?id=<?=$id?>" class="nav-link home">
                ...
                <li class="nav-item">
                    <a href="mom_feed.php?id=<?=$id?>" class="nav-link feed">
                ...
                <li class="nav-item">
                    <a href="mom_messages.php?id=<?=$id?>" class="nav-link chat">
                ...
                <li class="nav-item">
                    ...
                    <a href="mom_mychildren.php?id=<?=$id?>" class="nav-link room">
