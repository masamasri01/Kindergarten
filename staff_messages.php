...
<head>
    ...
    <title>Messages | Kinder Home</title>
...
// Close connection
			...
			s.cdpn.io/1940306/ico_star.png" alt="">
                    ...
                    <form id="myform" action="staff_Group_chat.php?id=<?=$i?>" method="POST" >
                        <div class="inner_div" id="chathist">
                            <input type="hidden" name="momname" value="<?php $momname ?>">
                            <?php
                            $host = "localhost";
                            $user = "root";
                            $pass = "";
                                ...
                                <tr>
                                    <th>
                                        <input class="input1" type="text"
                                               id="uname" name="uname" placeholder=""
                                               value="<?php echo $momname?>">
                                    </th>
                                    <th>
